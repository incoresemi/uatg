...
from utg.utils import list_of_modules, rvtest_data
...
def generate_tests(work_dir,
    ...
    *assuming that the user does a check within the test_class.
    ...
    for module in modules:
        ...
        # TODO: Move CODE_BEGIN, CODE_END to ASM generation part
        asm_header = f'# Licensing information can be found at LICENSE.' \
                     ...
                     f'\nRVMODEL_BOOT\n'
        rvcode_begin = 'RVTEST_CODE_BEGIN\n\n'
        rvcode_end = '\n\nRVTEST_CODE_END\nRVMODEL_HALT\n'
        rvmodel_data_begin = '\n\nRVMODEL_DATA_BEGIN'
        rvmodel_data_end = '\n\nRVMODEL_DATA_END'
        ...
        for plugin in manager.getAllPlugins():
            ...
            if check:
                ...
                asm = asm_header + rvcode_begin + asm_body + rvcode_end
                asm += rvtest_data(bit_width=32, num_vals=1, random=True,
                                   signed=False, align=4)
